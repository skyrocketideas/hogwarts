...
function ravenclawStats() {
	...
	document.getElementById("numberInRavenclaw").textContent = numberInRavenclaw;
	hufflepuffStats();
}
...
function slytherinStats() {
	...
	document.getElementById("numberInSlytherin").textContent = numberInSlytherin;
	allStats();
}
